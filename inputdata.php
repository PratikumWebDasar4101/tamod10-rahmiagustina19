...
<body>
    ...
    <table align="center">
        ...
        <tr><td>
            ...
            <td>
                <input type="checkbox" name="hobi[]" value="renang">Membaca
                <input type="checkbox" name="hobi[]" value="makan">Menyanyi
                <input type="checkbox" name="hobi[]" value="main">Travelling
            </td>
        <tr>
            <td>
                Genre Film
