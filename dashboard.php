...
<div class="row">
  <div class="col-3">
    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-jurnal10" role="tab" aria-controls="v-pills-home" aria-selected="true">Tugas Akhir 10</a>
      <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="inputdata.php" role="tab" aria-controls="v-pills-profile" aria-selected="false">Add Data</a>
...
<h3><center>Selamat Datang Di Praktikum Webdas</center></h3>
    <tr>
      <td>
